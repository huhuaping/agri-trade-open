...
### [5.3 具体任务](#special-aim)

### [5.4 扩展任务](#extension-aim)

### [5.5 技能要求](#skill-needed)
...
- **数据录入人**：根据任务分工，进行**粒度数据**（包括原始数据和标准数据）收集和处理的人员。
...
- 按“项目制”进行任务分工和推进。github repo。[见我们的github仓库huhuaping/agri-trade-open](https://github.com/huhuaping/agri-trade-open)。
...
- **写作任务**：a.目前已经可以开始着手写中国海关数据分析的一篇论文（.red[具体落实到人]）。b.结合国际贸易政策的最新热点，撰写一篇定性分析论文（.red[具体落实到人]）。
